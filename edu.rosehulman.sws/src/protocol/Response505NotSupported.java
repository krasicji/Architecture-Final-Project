...
public class Response505NotSupported extends HttpResponse {
	 ...
	 */
	public Response505NotSupported(String connection) {
		super(Protocol.VERSION, Protocol.NOT_SUPPORTED_CODE, Protocol.NOT_SUPPORTED_TEXT, new HashMap<String, String>(), null);
