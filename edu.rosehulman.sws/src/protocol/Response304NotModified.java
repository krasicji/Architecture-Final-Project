...
public class Response304NotModified extends HttpResponse {
	 ...
	 */
	public Response304NotModified(String connection) {
		super(Protocol.VERSION, Protocol.NOT_MODIFIED_CODE, Protocol.NOT_MODIFIED_TEXT, new HashMap<String, String>(), null);
